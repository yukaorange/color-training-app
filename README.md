...
- フロントエンドエンジニアとして、必要な能力を養うことと、デザインのバランス感覚を養うことの両立を目的としたアプリケーション開発を画策したことを発端にプロジェクトを始動しました。
- 幻冬舎から出版された「勝てるデザイン」（著:前田高志、幻冬舎）に掲載されていた、”色を使う”感覚を養うためのトレーニングが紹介されており、これが当初の目的に合致する内容であったため、作成することを決意。
- 
